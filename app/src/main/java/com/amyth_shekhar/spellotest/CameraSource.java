...
public class CameraSource {
    ...
    private static final String TAG = "SpelloCamera";
    ...
    private float mRequestedFps = 10f;
...
//        private final Detector<?> mDetector;
        ...
        public Builder setSceneMode(@SceneMode String mode)
        {
            mCameraSource.mSceneMode = mode;
            return this;
        }
...
*/
    ...
    private Camera createCamera() {
        ...
        // Make Arrangements for the Scenario where the arguments are null
        ...
        {
            Log.e(TAG, "Camera focus is not supported on this device.");
            mFocusMode = null;
        }
        ...
        {   // setting mFlashMode to the one set in the params
            mFlashMode = null;
            Log.e(TAG, "Camera flash mode: " + mFlashMode + " is not supported on this device.");
        }
        ...
        if(parameters.getSupportedSceneModes() != null)
        {
            if (mSceneMode != null)
            {
                if (parameters.getSupportedSceneModes().contains(mSceneMode))
                    parameters.setSceneMode(mSceneMode);
                else
                    Log.i(TAG, "Camera Scene mode: " + mFlashMode + " is not supported on this device.");
        ...
        {
            mSceneMode = null;
            Log.e(TAG, "Camera Scene is not supported on this device.");
        }

        /*String mColorEffect = Camera.Parameters.EFFECT_MONO;
        if(parameters.getSupportedColorEffects()  !=null)
        {
            if (parameters.getSupportedColorEffects().contains(mColorEffect))
                parameters.setColorEffect(mColorEffect);
            else
                Log.i(TAG, "Camera Color Mode : " + mColorEffect + " is not supported on this device.");
        }
        else
        {
            Log.e(TAG, "Camera Color Effect is not supported on this device.");
        }*/

        /*if(parameters.getMaxNumMeteringAreas()>0)
        {
            List<Camera.Area> meteringAreas = new ArrayList<Camera.Area>();
            Rect areaRect1 = new Rect(-1000, -200, 1000, 1000);    // specify an area in center of image
            meteringAreas.add(new Camera.Area(areaRect1, 800)); // set weight to 80%
            parameters.setMeteringAreas(meteringAreas);

        }
        else
        {
            Log.i(TAG, "Metring Area Not Supported  : " + " is not supported on this device.");
    ...
    private static SizePair selectSizePair(Camera camera, int desiredWidth, int desiredHeight) {
        ...
        Log.i(TAG, "final Preview Width x Height:- " +selectedPair.previewSize().getWidth() + " X " + selectedPair.previewSize().getHeight() );
        Log.i(TAG, "final Picture Width x Height:- " +selectedPair.pictureSize().getWidth() + " X " + selectedPair.pictureSize().getHeight() );
        ...
        for (Camera.Size previewSize : supportedPreviewSizes) {
            ...
            for (Camera.Size pictureSize : supportedPictureSizes) {
                ...
                //if (Math.abs(previewAspectRatio - pictureAspectRatio) < ASPECT_RATIO_TOLERANCE) {
                    ...
                    //Log.i(TAG, "Preview Size added:- " + previewSize.width + " X " + previewSize.height );
                    //Log.i(TAG, " Picture Size added :- " + pictureSize.width + " X " + pictureSize.height);
